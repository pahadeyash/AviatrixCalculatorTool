...
function avx_instance_script(f){
  switch (f.bandwidth.value){
    case "50":
      ...
      f.avx_instance.value = (0.012 * 24 * 365 * f.number_tunnels.value).toFixed(2);
      break;
    case "100":
      f.avx_instance_type_output.value = "t2.micro";
      f.avx_instance.value = (0.012 * 24 * 365 * f.number_tunnels.value).toFixed(2);
    ...
    case "200":
      ...
      f.avx_instance.value = (0.2 * 24 * 365 * f.number_tunnels.value).toFixed(2);
      break;
    case "300":
      f.avx_instance_type_output.value = "m4.xlarge";
      f.avx_instance.value = (0.2 * 24 * 365 * f.number_tunnels.value).toFixed(2);
    ...
    case "1000":
      ...
      f.avx_instance.value = (0.8 * 24 * 365 * f.number_tunnels.value).toFixed(2);
      break;
    case "10000":
      f.avx_instance_type_output.value = "m4.4xlarge";
      f.avx_instance.value = (0.8 * 24 * 365 * 10 * f.number_tunnels.value).toFixed(2);
      break;
  }
}
...
function regions_output_script(f){
  ...
  f.avx_licensing.value = f.number_tunnels.value * 300 * 12;
  avx_dia_script(f);
  recalculate(f);
}
